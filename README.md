...
«A4» У назвах файлів відсутні кирилиця, пробіли і трансліт. Назви містять тільки
...
«B13» Висота хедера визначається за рахунок контенту та вертикальних паддінгів
посиланнь.

«B14» У хедера є нижня рамка, необхідно сильно наблизити макет, щоб побачити її.

«B15» Висота усіх посилань в хедері визначається висотою контента та
вертикальними падінгами.

«B16» Секції розташовані одна під одною як стопка книг, без зовнішніх відступів.

«B17» Для всіх секцій використовується один клас .section, якому задані верхні і
нижні падінги по 120px, що відсувають контент всередину секції.

«B18» Для правильного приховування заголовка другої секції використовується
...
«B19» У картках секції Our Portfolio є рамка (властивість border), але тільки у
нижній частині картки.

Обов’язково перевірте ваш кінцевий результат. Готова 3ДЗ вже має повністю
відповідати макету.
